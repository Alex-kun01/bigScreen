<template>
  <div>
    ...
    <template v-if="car_type">
      <CarDetailList :community="plot_id" :carType="car_type - 1" @onclose="car_type = false" @openViewDetail="openViewDetail" />
    </template>
    <template v-if="carVisible || usualVisible">
      <CarPassRecordList :community="plot_id" :usualFlag="usualVisible" @closew='carVisible = false' />
    </template>
