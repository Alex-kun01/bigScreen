       ...
       <div class="left-box">
          <div class="item-box">
              <div class="title">
                ...
                :key="item.id"
                :class="{title:1,active: activeIndex == item.id}"
          ...
          <div class="item-box">
            <div class="title" style="color:#38A2F7;">
...
import histogamData from '../../assets/echartsData/histogramData.js'
// import ItemBox from '../ItemBox.vue'
import getPageData from '../../publicFun/moniPagination.js' // 模拟分页
import tableDatas from './staticDatas/tableDatas.js' // 表格数据
...
export default {
  data(){
    return{
      ...
      showTableData: [],
      // 表格一展示数据
      allTableData: tableDatas.all,
      echartsData: histogamData,
      // 报警信息列表
      allCallPoliceData: callPoliceDatas.all,
      callPoliceData: [],
      // 地勤民警信息列表
      allDjPoliceData: groundPoliceDatas.all,
      djPoliceData: [],
      // 控制弹出层
      popUp: false,
      popData: {
  ...
  methods:{
    ...
    initFloatBox(){
      let obj = {
          url: require('../../assets/images/people/people3.png'),
          dxx: 2,
          type: '出入报警',
          show: false,
          data: {
            info: ['姓名：张小波','重点类型：涉恐人员','出香槟国际-西门','2020.10.10 12:00:01'],
            alone: ''
          }
      }
