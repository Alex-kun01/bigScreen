...
import histogamData from '../../assets/echartsData/histogramData2.js'
let police1 = require('../../assets/images/police/police3.png')
let police2 = require('../../assets/images/police/police4.png')
...
export default {
  data(){
    return{
      ...
      // 表格一展示数据
      allTableData: tableDatas.drug,
      showTableData: [],
      echartsData: histogamData,
      // 报警信息列表
      allCallPoliceData: callPoliceDatas.drug,
      callPoliceData: [],
      // 地勤民警信息列表
      allDjPoliceData: groundPoliceDatas.drug,
      djPoliceData: [],
      // 控制弹出层
      popUp: false,
      popData: {
  ...
  methods:{
    ...
    initFloatBox(){
      let obj = {
          ...
          show: true,
          data: {
            info: ['姓名：黄小琥','重点类型：涉毒人员','出香槟国际-东门','2020.10.10 13:00:01'],
            alone: ''
          }
      }
