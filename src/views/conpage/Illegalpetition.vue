       ...
       <div class="left-box">
        ...
        <div class="con-box">
          ...
          <div class="leftFloatBox">
            ...
            <div class="l-item"><img src="../../assets/images/police.png" alt=""><span>网格员</span></div>
            ...
            <div class="tableBox">
              ...
              >
                ...
                <div class="djInfo">
                  ...
                  <div class="djText">编号：{{item.number}}</div>
...
import histogamData from '../../assets/echartsData/histogramData3.js'
let police1 = require('../../assets/images/police/police5.png')
let police2 = require('../../assets/images/police/police6.png')
...
export default {
  data(){
    return{
      ...
      // 表格一展示数据
      allTableData: tableDatas.ill,
      showTableData: [],
      echartsData: histogamData,
      // 报警信息列表
      allCallPoliceData: callPoliceDatas.ill,
      callPoliceData: {},
      // 地勤民警信息列表
      allDjPoliceData: groundPoliceDatas.ill,
      djPoliceData: [],
      // 控制弹出层
      popUp: false,
      popData: {
  ...
  methods:{
    ...
    initFloatBox(){
      let obj = {
          url: require('../../assets/images/people/people1.png'),
          dxx: 2,
          type: '出入报警',
          show: false,
          data: {
            info: ['姓名：吴静','重点类型：非法上访','出香槟国际-南门','2020.10.10 18:00:01'],
            alone: ''
          }
      }
    ...
    changeMj(){
      this.contentMapDataPolice = {
        ...
        data: {
            info: ['姓名：刘文媛','编号：1564787','电话：1817987985','距离事发地：2.5km'],
            alone: popel3
          }
      }
      this.contentMapShowPolice = true
