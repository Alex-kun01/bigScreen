...
var exampleConfig = {
        ...
        content: {
			...
			"spatial-search": {
                ...
                content: [
					...
					{
                        name: "GPU空间查询",
                        name_en: "GPUgetFeatureByGeometry",
    ...
    "KMLAndModel": {
        ...
        content: {
			...
			"geologicBody-model":{
				name:"地质体模型",
				name_en:"geologicBody model",
				content:[
					{
                        name: "地质体拉伸与剖切",
                        name_en: "geologic body stretch",
                        thumbnail: "geologicBodyStretch.jpg",
                        fileName: "geologicBodyOperation"
                    },
					{
                        name: "地质体裁剪与开挖",
                        name_en: "geologic body clip",
        ...
        content: {
            "plotting": {
                ...
                content: [
                    ...
                    {
                        name: "标号转json",
                        name_en: "geometry conversion json",
