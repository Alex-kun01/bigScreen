(function(){
    ...
    var nav=[
        ...
        {href:"./examples/component/examples.html",text:"vue组件"},
		...
		{href:"",text:"技术专题",dropdown:[
            ...
            {href:"./examples/TopicDoc/HowToUseToken.html",text:"token的使用手册"},
            {href:"./examples/TopicDoc/点外挂模型子对象选择.html",text:"点外挂模型子对象选择操作手册"},
